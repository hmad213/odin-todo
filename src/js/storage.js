...
class Storage {
  ...
  getData(projectList) {
    ...
    if (data === null) {
      ...
      projectList[0].addTodo(
        new Todo(
          "Call the bank",
          "Inquire about credit card offers and eligibility",
          new Date("2025-04-04"),
          true,
          true,
        ),
      ...
      projectList[1].addTodo(
        new Todo(
          "Buy Groceries",
          "Get vegetables, milk, and snacks",
          new Date("2025-04-01"),
          true,
          false,
        ),
      ...
      projectList[2].addTodo(
        new Todo(
          "Finish project report",
          "Complete the final draft of the quarterly report",
          new Date("2025-04-05"),
          true,
          false,
        ),
      ...
      projectList[2].addTodo(
        new Todo(
          "Team meeting",
          "Discuss upcoming features and deadlines",
          new Date("2025-04-03"),
          true,
          false,
        ),
      );
      projectList[3].addTodo(
        new Todo(
          "Fix leaking faucet",
          "Replace the kitchen sink washer",
          new Date("2025-04-06"),
          false,
          true,
        ),
      ...
      projectList[3].addTodo(
        new Todo(
          "Repaint bedroom",
          "Choose a new color and repaint the walls",
          new Date("2025-04-10"),
          false,
          false,
        ),
